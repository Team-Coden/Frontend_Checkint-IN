...
return (
 ...
 <section
  ...
  <div className="mx-auto max-w-4xl text-center">
   ...
   <p className="mx-auto mb-8 max-w-2xl text-pretty text-lg leading-relaxed text-foreground md:text-xl">
 ...
 <section className="border-b py-12">
  ...
  <div className="grid gap-8 md:grid-cols-3">
   ...
   <div>
    ...
    <p className="text-sm text-foreground">Estudiantes Activos</p>
   </div>
   </div>
   <div className="flex items-center gap-4">
   <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
   ...
   <div>
    ...
    <p className="text-sm text-foreground">Centros de Trabajo</p>
   </div>
   </div>
   <div className="flex items-center gap-4">
   <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
   ...
   <div>
    ...
    <p className="text-sm text-foreground">Tasa de Éxito</p>
   </div>
   </div>
  </div>
  </div>
 ...
 <section className="py-20">
  ...
  <div className="mb-16 text-center">
   ...
   <p className="mx-auto max-w-2xl text-pretty text-lg leading-relaxed text-foreground dark:text-white"> 
  ...
  <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
   ...
   <CardHeader>
    ...
    <CardDescription className="text-foreground dark:text-white"> 
 ...
 <section className="border-y bg/30 py-20">
  <div className="container mx-auto px-6">
  <div className="mb-16 text-center">
   <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">¿Por qué elegir CHECKiNT?</h2>
   <p className="mx-auto max-w-2xl text-pretty text-lg leading-relaxed text-foreground dark:text-white"> 
   Una plataforma diseñada para maximizar la eficiencia y transparencia en la gestión de pasantías
   </p>
  </div>

  <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
   <div className="flex gap-4">
   {/* Restaurando colores primarios */}
   <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10">
    <Zap className="h-5 w-5 text-primary" />
   </div>
   <div>
    <h3 className="mb-2 font-semibold">Automatización Inteligente</h3>
    <p className="text-sm leading-relaxed text-foreground dark:text-white"> 
 ...
 <footer className="border-t bg/30 py-12">
  ...
  <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
   ...
   {/* Restaurando text-primary para iNT */}
   <h3 className="mb-4 text-2xl font-bold">
    CHECK<span className="text-primary">iNT</span>
   </h3>
   <p className="mb-6 max-w-sm text-pretty text-sm leading-relaxed text-foreground dark:text-white"> 
  ...
  <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
   <div className="flex flex-wrap items-center gap-4 text-sm text-foreground dark:text-white"> 
   ...
   <p className="text-sm text-foreground dark:text-white">&copy; 2025 CHECKiNT. Todos los derechos reservados.</p> 
  </div>
  </div>
 </footer>
 </div>
