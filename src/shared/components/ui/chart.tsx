...
// Defining common props manually to avoid property conflicts
type RechartsTooltipProps = Omit<
  React.ComponentProps<typeof RechartsPrimitive.Tooltip>,
  "content" | "payload" | "label"
>

interface ChartTooltipContentProps extends RechartsTooltipProps, React.ComponentProps<"div"> {
  // Manual re-definition of Recharts props with explicit types
...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    const [item] = payload
    // Safely retrieve key, using string coercion
      ...
      <div className="grid gap-1.5">
        {payload
          ...
          .map((item, index) => {
            ...
            return (
              <div
                // FIX: Cast item.dataKey to string to satisfy React's Key type requirement
